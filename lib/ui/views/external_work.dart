...
class ExternalWork extends StatefulWidget {
  @override
  _ExternalWork createState() => _ExternalWork();
}

class _ExternalWork extends State<ExternalWork> {
                ...
                child: FlatButton(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text("Nhập đăng ký công tác ngoài nhân viên", style: TextStyle(fontSize: 12.0),)
                    ],
                  ),
                ),
              ),
